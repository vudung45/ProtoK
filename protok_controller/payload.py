...
with open("templates/kafka_trigger_deployment_template.json", "r") as f:
	kafka_new_deployment_payload = json.loads(f.read())
...
class ServerlessDeploymentPayload:
	service_name = ""
	def __init__(self, service_name, type="http-trigger"):
	...
	def generate_payload(self):
		...
		if self.type == "kafka":
			deployment_payload = dict(kafka_new_deployment_payload)
